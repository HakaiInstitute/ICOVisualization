...
`
  ...
  main.variable(observer("header")).define("header", ["md","selectedSite"], function(md,selectedSite){return(
md`
  ...
  main.variable(observer("viewof rects")).define("viewof rects", ["d3","gridding","list","grid"], function(d3,gridding,list,grid)
{
  ...
  main.variable(observer("style")).define("style", ["html","grid_width","img_height"], function(html,grid_width,img_height){return(
html`
<style>
...
.fader {filter: saturate(55%) brightness(60%) opacity(70%)}
...
[
  ...
  main.variable(observer("gridding")).define("gridding", ["d3","grid_width","img_height"], function(d3,grid_width,img_height){return(
d3
  .gridding()
  .mode('grid')
  .size([grid_width, img_height])
  .offset([0, 0])
)});
  main.variable(observer("grid_width")).define("grid_width", ["width"], function(width){return(
width / 1.5
)});
